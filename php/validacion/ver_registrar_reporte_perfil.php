...
if(count($reg_seleccionado) > 1){
	array_push($arr_mensajes,'39'); 	//registra el codigo del mensaje que se debe mostrar
	array_push($arr_parametro,'Permisos Reportes'); 	//registra el codigo del mensaje que se debe mostrar
	$proceso			= NULL;		//no procesa nada
	$consulta			= "ver_consultar_tabla_autonoma.php"; //lo envia a la pagina anterior
	$salida				= "ver_consultar_tabla_autonoma.php"; //lo envia a la pagina anterior
}
