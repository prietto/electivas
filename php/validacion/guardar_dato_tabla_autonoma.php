...
if(!$row_usuario){
	...
	for($i=0; $i<$num_registros; $i++){
		...
		if($ind_not_null && ($value_columna == NULL  || $value_columna == '0') ){
			...
			if($ind_list_box== false){ // si es un listbox
...
$txt_validacion_php			=	"../validacion/".$row_autonoma_personalizado['txt_validacion_php'];
if(file_exists($txt_validacion_php)){
	include($txt_validacion_php);	
}
